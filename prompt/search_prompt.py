RAG_SIMPLE_SYSTEM_PROMPT = '''Using the information contained in the context,
...
'''
RAG_SIMPLE_USER_PROMPT = '''Context:
{context}
---
...
##https://github.com/BUAADreamer/EasyRAG 基于llama_index二次开发
QA_TEMPLATE = """\
    上下文信息如下：
    ----------
    {context_str}
...
##https://huggingface.co/learn/cookbook/zh-CN/rag_evaluation RAG评估
