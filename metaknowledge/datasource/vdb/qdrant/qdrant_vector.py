...
# from metaknowledge.datasource.vdb.field import Field
# from metaknowledge.datasource.vdb.vector_base import BaseVector
...
class QdrantVectorFactory(AbstractVectorFactory):
    def init_vector(self, collection_name: str, attributes: list, embeddings: Embeddings) -> QdrantVector:
        ...
        return QdrantVector(
            ...
            config=QdrantConfig(
                ...
                root_path="",
                timeout=os.getenv["QDRANT_CLIENT_TIMEOUT"],
                grpc_port=os.getenv["QDRANT_GRPC_PORT"],
                prefer_grpc=os.getenv["QDRANT_GRPC_ENABLED"],
            ),
        )
