...
from entities.daataset_keyword_table import DatasetKeywordTable
from entities.document import Document
from metaknowledge import storage
from metaknowledge.datasource.keyword.jieba.jieba_keyword_table_handler import JiebaKeywordTableHandler
from metaknowledge.datasource.keyword.keyword_base import BaseKeyword
...
class Jieba(BaseKeyword):
    ...
    def _get_dataset_keyword_table(self) -> Optional[dict]:
        ...
        # else:
        keyword_data_source_type = self.config["KEYWORD_DATA_SOURCE_TYPE"]
